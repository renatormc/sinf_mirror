...
go build -a -o "%SINFTOOLS%\tools\sinf_mirror\sinf_mirror.exe" && s-mirror -s C:\temp  -d D:\test\delete -l D:\test
REM go build -a -o "C:\Users\Will\Desktop\git\test go\sinf_mirror.exe" && "C:\Users\Will\Desktop\git\test go\sinf_mirror.exe" -s F:\pubgLite\PUBGLite -d R:\folder -l "C:\Users\Will\Desktop\logOutput"
